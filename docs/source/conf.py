...
# kedro_belib_pipeline documentation build
...
from kedro_belib_pipeline import __version__ as release

# -- Project information -----------------------------------------------------

project = "kedro_belib_pipeline"
author = "Kedro"
...
htmlhelp_basename = "kedro_belib_pipelinedoc"
...
latex_documents = [
    (
        master_doc,
        "kedro_belib_pipeline.tex",
        "kedro_belib_pipeline Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "kedro_belib_pipeline",
        "Project kedro_belib_pipeline codebase.",
        "Data-Science",
    )
]
